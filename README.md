...
02/27/22
- [X] Refactor Timer
- Register functionality working on both frontend and backend

02/28/22
-  Complete login functionality - frontend
-  Display User tasks
...
| GET | /api/v1/users/getUserById/id | Get a User |
| PUT |/api/v1/users/updateUser/id| Edit a User |
